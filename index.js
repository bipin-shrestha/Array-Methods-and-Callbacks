...
function homeTeam2014Final(item) {
  if (item.Year == 2014 && item.Stage == "Final") {
    console.log(item["Home Team Name"]);
  }
}

fifaData.forEach(homeTeam2014Final);

// (b) Away Team name for 2014 world cup final
function awayTeam2014Final(item) {
  if (item.Year == 2014 && item.Stage == "Final") {
    console.log(item["Away Team Name"]);
  }
}
fifaData.forEach(awayTeam2014Final);
// (c) Home Team goals for 2014 world cup final
function homeTeamGoals2014Final(item) {
  if (item.Year == 2014 && item.Stage == "Final") {
    console.log(item["Home Team Goals"]);
  }
}
fifaData.forEach(homeTeamGoals2014Final);
// (d) Away Team goals for 2014 world cup final
function awayTeamGoals2014Final(item) {
  if (item.Year == 2014 && item.Stage == "Final") {
    console.log(item["Away Team Goals"]);
  }
}
fifaData.forEach(awayTeamGoals2014Final);
// (e) Winner of 2014 world cup final
function winnerOf2014Final(item) {
  if (item.Year == 2014 && item.Stage == "Final") {
...
fifaData.forEach(winnerOf2014Final);
...
/* If you still have time, use the space below to work on any stretch goals of your chosing as listed in the README file.8 */
